...
pub(crate) use self::runtime::{ProjectionContext, ensure_page_hooks, sync_tabs_projection_with};
...
impl PageHookInstallState {
    ...
    pub(super) fn critical_runtime_hooks_complete(&self) -> bool {
        self.contains_all(CRITICAL_RUNTIME_HOOKS_MASK)
    }
...
pub(super) fn active_page_runtime_commit_ready(
